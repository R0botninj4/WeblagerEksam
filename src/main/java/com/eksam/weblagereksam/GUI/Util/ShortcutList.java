...
public class ShortcutList {
    ...
    public static List<Shortcut> all() {
        return List.of(
                ...
                new Shortcut("Scanner", "X", "Split document at current page"),
                new Shortcut("Scanner", "M", "Merge document with previous"),
                new Shortcut("Scanner", "Slideshow", "Show all pages automatically"),
                new Shortcut("Scanner", "Drag page", "Move page or change page order"),
